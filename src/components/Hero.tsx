          ...
          {[
            ...
            <div key={item.label}
              className={`px-2.5 py-1.5 rounded-lg text-[10px] font-medium ${
                item.active ? "bg-[#F3F3F3] text-[#000000]" : "text-[#333333]"
              }`}>
              {item.label}
            </div>
          ))}
        ...
        <div className="flex-1 bg-[#F8FAFC] p-4 overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-2">
              ...
              <div className="flex items-end gap-1" style={{ height: 64 }}>
                {bars.map((h, i) => (
                  <div key={i} className="flex-1 rounded-t"
                    style={{ height: `${h}%`, background: i === bars.length - 1 ? "#000000" : "#C7D2FE" }} />
                ))}
              </div>
            ...
            <div className="bg-white rounded-xl border border-[#EBEBEB] p-3">
              ...
              {[
                { name: "Acme Corp",     amt: "$12,400", tag: "L2", tagBg: "#FEF3C7", tagTx: "#000000" },
                { name: "TechFlow Inc",  amt: "$8,750",  tag: "L1", tagBg: "#F3F3F3", tagTx: "#000000" },
                ...
                <div key={inv.name} className="flex items-center justify-between py-1.5 border-b border-[#F5F5F5] last:border-0 gap-2">
                  ...
                  <span className="text-[9px] font-bold text-[#000000] shrink-0">{inv.amt}</span>
  ...
  return (
    <section className="bg-[#F8FAFC] pt-24 pb-0">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#C7D2FE] bg-[#F3F3F3] text-[#000000] text-[11px] font-semibold tracking-widest uppercase">
        ...
        >
          <a href="#pricing"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-[#000000] text-white text-[14px] font-semibold hover:bg-[#111111] transition-colors shadow-sm shadow-[#000000]/20">
            Book Free AR Audit
