      ...
      <div className="flex" style={{ height: 340 }}>
        ...
        <div className="w-[148px] shrink-0 bg-white border-r border-[#F0F0F0] flex flex-col p-3 gap-0.5">
          <div className="flex items-center gap-2 px-2 py-2 mb-2">
            <div className="w-5 h-5 rounded bg-[#D97706] flex items-center justify-center shrink-0">
          ...
          {[
            ...
            <div key={item.label}
              className={`px-2.5 py-1.5 rounded-lg text-[10px] font-medium ${
                item.active ? "bg-[#FFFBEB] text-[#D97706]" : "text-[#333333]"
              }`}>
              {item.label}
            </div>
          ))}
        ...
        <div className="flex-1 bg-[#F8FAFC] p-4 overflow-hidden">
          ...
          <div className="grid grid-cols-3 gap-2 mb-3">
            {[
              { label: "Total AR Outstanding", value: "$847,200", sub: "↓ collecting fast", color: "#D97706" },
          ...
          <div className="grid grid-cols-2 gap-2">
              ...
              <div className="flex items-end gap-1" style={{ height: 64 }}>
                {bars.map((h, i) => (
                  <div key={i} className="flex-1 rounded-t"
                    style={{ height: `${h}%`, background: i === bars.length - 1 ? "#D97706" : "#C7D2FE" }} />
                ))}
              </div>
            ...
            <div className="bg-white rounded-xl border border-[#EBEBEB] p-3">
              ...
              {[
                ...
                { name: "TechFlow Inc",  amt: "$8,750",  tag: "L1", tagBg: "#FFFBEB", tagTx: "#D97706" },
                ...
                <div key={inv.name} className="flex items-center justify-between py-1.5 border-b border-[#F5F5F5] last:border-0 gap-2">
                  ...
                  <span className="text-[9px] font-bold text-[#D97706] shrink-0">{inv.amt}</span>
  ...
  return (
    <section className="bg-[#F8FAFC] pt-24 pb-0">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#C7D2FE] bg-[#FFFBEB] text-[#D97706] text-[11px] font-semibold tracking-widest uppercase">
        ...
        >
          ...
          <span className="text-[#D97706]">DataByt collects them.</span>
        </motion.h1>
        ...
        >
          <a href="#pricing"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-[#D97706] text-white text-[14px] font-semibold hover:bg-[#B45309] transition-colors shadow-sm shadow-[#D97706]/20">
            Book Free AR Audit
