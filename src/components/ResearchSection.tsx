  ...
  return (
    <section className="bg-white py-20 border-b border-[#E8E8E8]">
      <div className="max-w-6xl mx-auto px-6">
          ...
          {findings.map((f, i) => (
            ...
            >
              <div className="flex items-start justify-between mb-4 gap-3">
                ...
                <div className="w-9 h-9 rounded-lg bg-[#EEF2FF] flex items-center justify-center shrink-0 group-hover:bg-[#4F46E5] transition-colors">
        ...
        >
          <p className="text-[11px] text-[#4F46E5] uppercase tracking-widest font-semibold mb-5">Primary sources</p>
            ...
            {sources.map((s, i) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <ExternalLink className="w-3 h-3 text-[#4F46E5]/30 group-hover:text-[#4F46E5] transition-colors" />
                </div>
