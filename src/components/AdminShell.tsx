  ...
  const Sidebar = ({ mobile = false }: { mobile?: boolean }) => (
    <div className={`flex flex-col ${mobile ? "h-full" : "h-screen sticky top-0"} w-[240px] bg-white border-r border-[#E2E8F0]`}>
                ...
                {orgs.length === 0 ? (
                  ...
                  orgs.map(org => (
                    ...
                    >
                      ...
                      {org.overdueCount > 0 && (
                        <span className="text-[10px] font-medium text-[#DC2626] bg-[#FEF2F2] border border-[#EF4444]/20 px-1.5 py-0.5 rounded-full">
                          {org.overdueCount}
                        </span>
                      )}
                    </button>
      ...
      {orgs.some(o => o.overdueCount > 0) && (
        <div className="mx-3 mb-3 flex items-center gap-2 px-3 py-2.5 rounded-lg bg-[#FEF2F2] border border-[#EF4444]/20">
      ...
      <div className="border-t border-[#E2E8F0] p-3">
        <div className="flex items-center gap-3">
          ...
          <button onClick={signOut} className="text-[#94A3B8] hover:text-[#E8242A] transition-colors p-1 shrink-0" title="Sign out">
