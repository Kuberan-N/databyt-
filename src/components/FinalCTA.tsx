      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-[32px] sm:text-[42px] font-extrabold text-white leading-[1.1] tracking-[-0.025em] mb-5">
            ...
            your invoices age{" "}
            <span className="text-[#A5B4FC]">7 more days.</span>
          </h2>
          <p className="text-white/70 text-[15px] mb-7 max-w-lg leading-relaxed">
          ...
          <div className="flex flex-wrap items-center gap-5 text-white/60 text-[12px]">
