          ...
          <motion.div initial={{ opacity: 0, scale: 0.96, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.96 }}
            ...
            <div className="glass rounded-2xl p-6 w-full max-w-md">
              ...
              <form onSubmit={handleSave} className="space-y-4">
                <div>
                  <label className="text-[#475569] text-sm font-medium mb-1.5 block">Customer *</label>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="text-[#475569] text-sm font-medium mb-1.5 block">Invoice # *</label>
                  ...
                  <div>
                    <label className="text-[#475569] text-sm font-medium mb-1.5 block">Currency</label>
                ...
                <div>
                  <label className="text-[#475569] text-sm font-medium mb-1.5 block">Amount *</label>
                  <div className="relative">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="text-[#475569] text-sm font-medium mb-1.5 block">Issue Date *</label>
                  ...
                  <div>
                    <label className="text-[#475569] text-sm font-medium mb-1.5 block">Due Date *</label>
                    <input type="date" value={dueDate} onChange={e => setDueDate(e.target.value)} required
                      className="w-full bg-surface-800/50 border border-surface-700 rounded-xl px-4 py-2.5 text-white text-sm focus:border-primary-500 outline-none" />
                  </div>
                </div>
                <div className="flex gap-3 pt-1">
                  <button type="button" onClick={onClose} className="flex-1 py-2.5 rounded-xl border border-surface-700 text-[#475569] text-sm">Cancel</button>
