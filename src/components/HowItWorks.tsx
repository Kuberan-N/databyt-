    ...
    <section id="how-it-works" className="bg-white py-20 border-y border-[#E8E8E8]">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <p className="text-[#D97706] text-[11px] font-semibold uppercase tracking-widest mb-3">The Product</p>
          <h2 className="text-[30px] sm:text-[38px] font-bold text-[#111111] leading-[1.15] tracking-[-0.02em] max-w-[580px]">
            ...
            <span className="text-[#D97706]">Closed end-to-end.</span>
          </h2>
            ...
            >
              <div className="flex items-center justify-between mb-5">
                <div className="w-9 h-9 rounded-lg bg-[#FFFBEB] flex items-center justify-center">
                  <s.icon className="w-[18px] h-[18px] text-[#D97706]" />
                </div>
                <span className="text-[#D97706] font-bold text-[13px]">{s.num}</span>
              </div>
        ...
        >
          <a href="/auth"
            className="inline-flex items-center gap-2 px-5 py-3 rounded-lg bg-[#D97706] text-white text-[14px] font-semibold hover:bg-[#B45309] transition-colors">
            Start Free Trial
