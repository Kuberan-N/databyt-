        ...
        <div className="p-4 flex items-center justify-between border-b border-[#E2E8F0] h-16">
          ...
          {!sidebarOpen && (
            <div className="mx-auto">
              <span className="font-black text-[#000000] text-lg">D</span>
            </div>
          )}
          <button
            ...
            >
              ...
              <div className="border-t border-[#E2E8F0] p-4">
                <button
                  ...
                  className="flex items-center gap-2 text-[#222222] hover:text-[#000000] text-sm"
                >
                  <LogOut className="w-4 h-4" />
                  Sign Out
                </button>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-16 bg-white border-b border-[#E2E8F0] flex items-center justify-between px-4 sm:px-6 shrink-0">
          <div className="flex items-center gap-3">
            <button className="lg:hidden text-[#222222] hover:text-[#000000]" onClick={() => setMobileMenuOpen(true)}>
