            ...
            >
              {plan.featured && (
                <div className="absolute -top-3 left-6">
                  <span className="bg-[#000000] text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest">
                    Full Suite
                  </span>
                </div>
              )}
              ...
              <ul className="space-y-2.5 flex-1">
                {plan.features.map((f, j) => (
                  <li key={j} className="flex items-start gap-2.5 text-[13px]">
                    <Check className={`w-3.5 h-3.5 mt-0.5 shrink-0 ${plan.featured ? "text-[#000000]" : "text-[#000000]"}`} />
