    ...
    <section id="pricing" className="bg-white py-20 border-b border-[#E8E8E8]">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <p className="text-[#D97706] text-[11px] font-semibold uppercase tracking-widest mb-3">Pricing</p>
            ...
            >
              {plan.featured && (
                <div className="absolute -top-3 left-6">
                  <span className="bg-[#D97706] text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest">
                    Full Suite
                  </span>
                </div>
              )}
              ...
              <ul className="space-y-2.5 flex-1">
                {plan.features.map((f, j) => (
                  <li key={j} className="flex items-start gap-2.5 text-[13px]">
                    <Check className={`w-3.5 h-3.5 mt-0.5 shrink-0 ${plan.featured ? "text-[#D97706]" : "text-[#D97706]"}`} />
