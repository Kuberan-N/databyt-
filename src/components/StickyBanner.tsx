...
export default function StickyBanner() {
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-[#3730A3] text-white text-center py-2.5 px-4">
      <p className="text-xs sm:text-sm font-semibold">
        <span className="inline-block w-2 h-2 rounded-full bg-[#0D9488] mr-2 animate-pulse" />
