...
function StatCard({
  label, value, sub, icon: Icon, iconColor = "#E8242A", delay = 0,
}: {
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="pt-3 border-t border-[#E2E8F0]">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold text-[#E8242A]">{d.emailEffectiveness.paymentConversionRate}%</span>
                </div>
              </div>
            </div>
          ) : (
        ...
        {d && d.monthlyTrend.some(m => m.collected > 0) ? (
          <ResponsiveContainer width="100%" height={220}>
            <BarChart data={d.monthlyTrend} barSize={36}>
              ...
              />
              <Bar dataKey="collected" fill="#E8242A" radius={[6, 6, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        ) : (
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}
        className="rounded-2xl p-5 bg-[#FEF2F2] border border-[#E8242A]/15">
        <p className="text-xs font-semibold text-[#E8242A] mb-1">What is CEI?</p>
