...
function StatCard({
  label, value, sub, icon: Icon, iconColor = "#059669", delay = 0,
}: {
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="pt-3 border-t border-[#E2E8F0]">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold text-[#059669]">{d.emailEffectiveness.paymentConversionRate}%</span>
                </div>
              </div>
            </div>
          ) : (
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}
        className="rounded-2xl p-5 bg-[#ECFDF5] border border-[#059669]/15">
        <p className="text-xs font-semibold text-[#059669] mb-1">What is CEI?</p>
