...
const selectCls = "w-full bg-white border border-[#E2E8F0] rounded-xl px-4 py-3 text-[#0F172A] focus:border-[#0D9488] focus:ring-1 focus:ring-[#0D9488]/20 outline-none transition-all text-sm appearance-none";
        ...
        <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }}
          className={`flex items-center gap-2 px-4 py-3 rounded-xl text-sm ${
            status === "success"
              ...
              : "bg-[#F0FDFA] border border-[#FECACA] text-[#DC2626]"
          }`}>
      ...
      <form onSubmit={handleSave} className="space-y-5">
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
          ...
          <textarea value={emailSignature} onChange={(e) => setEmailSignature(e.target.value)}
            ...
            className="w-full bg-white border border-[#E2E8F0] rounded-xl px-4 py-3 text-[#0F172A] placeholder-[#333333] focus:border-[#0D9488] focus:ring-1 focus:ring-[#0D9488]/20 outline-none transition-all text-sm resize-none font-mono" />
        </motion.div>

        <button type="submit" disabled={saving}
          className="flex items-center gap-2 px-6 py-3 bg-[#0D9488] text-white rounded-xl font-semibold hover:bg-[#0F766E] transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm">
          {saving
      ...
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
        ...
        <div className="flex items-center justify-between">
          ...
          <a href="/auth/reset-password"
            className="text-xs text-[#0D9488] font-medium px-3 py-1.5 rounded-lg border border-[#0D9488]/20 bg-[#F0FDFA] hover:bg-[#E0E7FF] transition-colors">
            Change Password
          </a>
        </div>
      </motion.div>
