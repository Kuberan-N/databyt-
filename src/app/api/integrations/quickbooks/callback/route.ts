...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.redirect(`${baseUrl}/dashboard/integrations?error=quickbooks_state`);
  }
  ...
  try {
    ...
    return NextResponse.redirect(`${baseUrl}/dashboard/integrations?error=quickbooks_token`);
  }
}
